...
PATH_RESNET_NO_LAYER_TENSORRT_ONNX_0 = r"stage_0/resnet_no_layer_tensorrt_0.onnx"
...
# Model without layer fuion without tensorrt 
PATH_RESNET_NO_LAYER_NO_TENSORRT_MODEL_1 = r"stage_1/resnet_no_layer_no_tensorrt_1.pth"

# Model without fusion and with tensorrt
PATH_RESNET_NO_LAYER_TENSORRT_ONNX_1 = r"stage_1/resnet_no_layer_tensorrt_1.onnx"    
PATH_RESNET_NO_LAYER_TENSORRT_ENGINE_1 = r"stage_1/resnet_no_layer_tensorrt_1.trt"

# Model with Fusion and witout Tensorrt 
PATH_RESNET_LAYER_NO_TENSORRT_MODEL_1 = r"stage_1/resnet_layer_no_tensorrt_1.pth"

# Model with Layer and with TensorRT
PATH_RESNET_LAYER_TENSORRT_ONNX_1 = r"stage_1/resnet_layer_tensorrt_1.onnx"
PATH_RESNET_LAYER_TENSORRT_ENGINE_1 = r"stage_1/resnet_layer_tensorrt_1.trt"
...
# Model without layer fuion without tensorrt 
PATH_RESNET_NO_LAYER_NO_TENSORRT_MODEL_2 = r"stage_2/resnet_no_layer_no_tensorrt_2.pth"

# Model without fusion and with tensorrt
PATH_RESNET_NO_LAYER_TENSORRT_ONNX_2 = r"stage_2/resnet_no_layer_tensorrt_2.onnx"    
PATH_RESNET_NO_LAYER_TENSORRT_ENGINE_2 = r"stage_2/resnet_no_layer_tensorrt_2.trt"

# Model with Fusion and witout Tensorrt 
PATH_RESNET_LAYER_NO_TENSORRT_MODEL_2 = r"stage_2/resnet_layer_no_tensorrt_2.pth"

# Model with Layer and with TensorRT
PATH_RESNET_LAYER_TENSORRT_ONNX_2 = r"stage_2/resnet_layer_tensorrt_2.onnx"
PATH_RESNET_LAYER_TENSORRT_ENGINE_2 = r"stage_2/resnet_layer_tensorrt_2.trt"
...
stage0 = get_first_stage_resnet(model)
stage1 = get_second_stage_resnet(model)
stage2 = get_third_stage_resnet(model)
...
def save_model_witout_fusion_witout_tensorrt(stage):
    ...
    if(stage == 0):
        ...
        model_in_stage = get_third_stage_resnet(model)
...
def save_model_with_fusion_without_tensorrt(stage):
    ...
    if(stage == 0):
        ...
        print("\n---------STAGE 2-------\n")
        stage_2 = get_third_stage_resnet(model)
...
def create_onnx_and_engine_for_stage2(model_path_stage_2, fused = False, batch_size = 16):
    ...
    stage0_resnet = get_first_stage_resnet(model)
    stage1_resnet = get_second_stage_resnet(model)
    stage_2_resnet = get_third_stage_resnet(model)

    if(fused):
        stage_2_resnet = fuse_resnet(stage_2_resnet)

    # Load the model FOR STAGE 1
    stage_2_resnet.load_state_dict(torch.load(model_path_stage_2, weights_only=True)) 
    ...
    stage0_output = stage0_resnet(input_tensor)
    stage1_output = stage1_resnet(stage0_output)
    ...
    # Create ONNX file for split model
    create_onnx_from_model(stage_2_resnet, onnx_file_name, stage1_output, batch_size) 
