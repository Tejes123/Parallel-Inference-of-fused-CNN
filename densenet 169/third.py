...
def without_fusion_without_tensorrt():
    ...
    stage_1 = get_third_stage_densenet(model)
...
def check_third():
    ...
    stage_0 = get_first_stage_densenet(model)
    stage_1 = get_second_stage_densenet(model)
    stage_2 = get_third_stage_densenet(model)
